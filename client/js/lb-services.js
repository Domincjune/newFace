...
/**
 * @ngdoc object
 * @name lbServices.Videos
 * @header lbServices.Videos
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Videos` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Videos#createMany
         * @methodOf lbServices.Videos
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Videos#findById
         * @methodOf lbServices.Videos
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Videos#findOne
         * @methodOf lbServices.Videos
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Videos#updateAll
         * @methodOf lbServices.Videos
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Videos#deleteById
         * @methodOf lbServices.Videos
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Videos#prototype$updateAttributes
         * @methodOf lbServices.Videos
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Videos#updateOrCreate
         * @methodOf lbServices.Videos
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Videos#destroyById
         * @methodOf lbServices.Videos
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Videos#removeById
         * @methodOf lbServices.Videos
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Videos#modelName
    * @propertyOf lbServices.Videos
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Videos`.
    */
